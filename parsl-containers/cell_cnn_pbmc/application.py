...
######### CONSTANTS #########
results_path = "./model/pbmc_results.json"
scaler_path = "./model/pbmc_scaler.save"
model_path = "./model/"
best_3_models = [0, 1, 2] # taken from the best models and stored in models folder
...
def test_run():
    data_path = "./data/pbmc_data.npy"
    labels_path = "./data/pbmc_labels.npy"
