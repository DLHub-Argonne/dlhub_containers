...
h_fea_len = 32
n_h = 1
model_path = "model/semi-metal-classification.pth.tar"
...
def run(data):
    ...
    # for t in test_preds:
    #     if t < 0 or t > 1:
    #         raise("Model returned invalid result. Prediction must be between 0 and 1")
    #     elif t < 0.5:
    #         pred_classifications.append("Metal")
    #     elif t > 0.5:
    #         pred_classifications.append("Semiconductor")
    #     else: #t == 0.5
    #         pred_classifications.append("Metal and Semiconductor equally likely")
